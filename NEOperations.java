...
public class NEOperations{
	public static void main(String[] args){
		...
		List<Map<String,String>> filteredNEList = ingressCosList.stream().filter((Map m) -> !(m.get("NEID").equals("S100-NE-0001"))).filter((Map m) -> !(m.get("NEID").equals("S100-NE-0002"))).collect(Collectors.toList());
...
class NERepository{
	...
	public static List<Map<String,String>> getIngressCosList(){
		...
		ingressCosMap.put("NEID","S100-NE-0001");
		ingressCosMapList.add(ingressCosMap);
		
		ingressCosMap = new HashMap<String,String>();		
		ingressCosMap.put("NEID","S100-NE-0002");
		ingressCosMapList.add(ingressCosMap);
		
		ingressCosMap = new HashMap<String,String>();		
		ingressCosMap.put("NEID","S100-NE-0003");
		ingressCosMapList.add(ingressCosMap);
		
		ingressCosMap = new HashMap<String,String>();		
		ingressCosMap.put("NEID","S100-NE-0004");
		ingressCosMapList.add(ingressCosMap);
		
		ingressCosMap = new HashMap<String,String>();		
		ingressCosMap.put("NEID","S100-NE-0005");
		ingressCosMapList.add(ingressCosMap);
